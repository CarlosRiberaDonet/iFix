...
public class QuerySQL {
    ...
    public static final String SELECT_ALL_REPARACIONES = "SELECT r.id, " + "r.fecha_entrada, " + "r.fecha_salida, " + "r.precio, " + "r.garantia, " + "r.comentarios, " + "r.id_marca AS idMarca, " + "r.id_modelo AS idModelo, " + "r.id_tipo_reparacion AS idReparacion, " + "r.id_cliente, " + "m.marca, " + "mo.modelo, " + "t.reparacion, " + "c.nombre, " + "c.apellidos, " + "c.telefono, " + "c.direccion " + "FROM reparacion r " + "JOIN marca m ON r.id_marca = m.id " + "JOIN modelo mo ON r.id_modelo = mo.id " + "JOIN tipo_reparacion t ON r.id_tipo_reparacion = t.id " + "JOIN cliente c ON r.id_cliente = c.id ";
    public static final String SELECT_REPARACIONES_BY_CLIENTE_ID = "SELECT r.id, " + "r.fecha_entrada, " + "r.fecha_salida, " + "r.precio, " + "r.garantia, " + "r.comentarios, " + "r.id_marca AS idMarca, " + "r.id_modelo AS idModelo, " + "r.id_tipo_reparacion AS idReparacion, " + "r.id_cliente, " + "m.marca, " + "mo.modelo, " + "t.reparacion, " + "c.nombre, " + "c.apellidos, " + "c.telefono, " + "c.direccion " + "FROM reparacion r " + "JOIN marca m ON r.id_marca = m.id " + "JOIN modelo mo ON r.id_modelo = mo.id " + "JOIN tipo_reparacion t ON r.id_tipo_reparacion = t.id " + "JOIN cliente c ON r.id_cliente = c.id " + "WHERE r.id_cliente = ?";
    ...
    public static final String MODIFICAR_REPARACION = "UPDATE reparacion SET " + "fecha_entrada = ?, " + "fecha_salida = ?, " + "precio = ?, " + "garantia = ?, " + "comentarios = ?, " + "id_marca = ?, " + "id_modelo = ?, " + "id_tipo_reparacion = ? " + "WHERE id = ?";
